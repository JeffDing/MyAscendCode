...
base_dir = '/home/model_user4/JeffDing/mydata/thucnews/'
...
def train():
    ...
    tf.io.write_graph(session.graph_def, 'result/checkpoints', 'train.pbtxt')
    ...
    total_time = end_timeAll-start_timeALL
    print("all epoch time:",total_time)
    print("step time:",total_batch/total_time)
    #msg = 'Test Acc: {0:>7.2%}'
