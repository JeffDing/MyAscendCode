...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='CAT_03', help='[mnist / cifar10 / custom_dataset]')
...
def main():
    ...
    #custom_op.parameter_map["profiling_options"].s = tf.compat.as_bytes('{"output":"./profiling", \
    #                                                                      "task_trace":"on", \
    #                                                                      "aicpu":"on"}') 
