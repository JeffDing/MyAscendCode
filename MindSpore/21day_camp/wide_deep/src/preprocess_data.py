...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_file", type=str, default="/cache/mini_demo.txt", help='the data file to be processed')
    ...
    local_train_url = '/cache/data'

    data_path = local_train_url
    data_file = '/cache/mini_demo.txt'
    mox.file.copy(args.data_file,data_file)
    ...
    mox.file.copy_parallel(output_path,args.train_url)
