...
import argparse
parser = argparse.ArgumentParser(description='Wide and Deep')
...
mox.file.copy_parallel(args_opt.checkpoint_path,'/cache/ckpt/widedeep_train-1_42.ckpt')
...
def test_eval(config):
    ...
    ckpt_path = '/cache/ckpt/widedeep_train-1_42.ckpt'
    if ";" in ckpt_path:
