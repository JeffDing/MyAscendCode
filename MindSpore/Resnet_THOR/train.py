...
if args_opt.device_target == "Ascend":
    ...
    mox.file.copy_parallel(args_opt.data_url,local_data_url)   #Copy dataset to environment in modelart or cloudbrain
...
if __name__ == '__main__':
    ...
    # create dataset
    dataset = create_dataset(dataset_path=local_data_url+"/imagenet/train", do_train=True, repeat_num=1,
