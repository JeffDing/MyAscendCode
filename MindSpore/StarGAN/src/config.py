...
def get_config():
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, default=r'/cache/data/img_align_celeba')
    parser.add_argument('--attr_path', type=str, default=r'/cache/data/list_attr_celeba.txt')
    parser.add_argument('--rafd_image_dir', type=str, default='/cache/data/RaFD/train')
