...
def parse_arguments():
    ...
    parser.add_argument('--data_path', default="./data", help='Location of data.')
    ...
    parser.add_argument("--run_qizhi", type=ast.literal_eval, default=False, help="Whether run on qizhi")
    parser.add_argument('--multi_data_url',help='path to multi dataset', default= '/cache/data/')
    parser.add_argument('--ckpt_url',help='path to multi dataset', default= '/cache/data/')
