...
parser.add_argument('--device_target', type=str, default='Ascend', help='only support GPU and Ascend')
...
parser.add_argument("--use_openi", type=bool, default=False, help="use openi")
parser.add_argument("--use_modelarts", type=bool, default=False, help="use modelarts")
