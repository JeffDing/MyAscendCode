...
def test_data(testdataset_path):
    ...
    test_path = os.path.join(testdataset_path, "images")
    ...
    for image_name in img_list:
        ...
        # mox.file.copy_parallel(src_url='./output_train', dst_url='obs://canncamp-temp/AIAC/output_train')
        #下载训练后的模型
        #关联保存模型的路径
        mox.file.copy_parallel(src_url='obs://canncamp-temp/AIAC/output_train', dst_url='/cache/output_train')
        param_dict = load_checkpoint("/cache/output_train/deeplabv3-20_1250.ckpt")
        # # 将参数加载到网络中
    ...
    mox.file.copy_parallel(src_url='/cache/gis/pre', dst_url='obs://canncamp-temp/AIAC/pre')
        # print("test=====", cnt)
    ...
    mox.file.copy_parallel(src_url='/cache/gis/pre_test', dst_url='obs://canncamp-temp/AIAC/pre_test')
