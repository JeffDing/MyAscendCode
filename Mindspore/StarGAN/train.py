...
parser.add_argument('--attr_path', type=str, default=None, help='attr path')
...
if __name__ == '__main__':
    ...
    if args_opt.modelarts:
        ...
        data_path = local_data_url + args_opt.data_path
        attr_path = local_data_url + args_opt.attr_path
